...
<script>
    ...
    function setLote(nomeLote){
    	
       dataInicial = $('#dt_ini').val();
       dataFinal = $('#dt_fin').val();
       tipoterminal = $( "#tipoterminal").val();
    ...
    function setChaves(){
    	...
    	if( $("#data_inicial_lote").val() != ""){
    		
    		$('#dt_ini').val($("#data_inicial_lote").val());
    	}
        if( $("#data_final_lote").val() != ""){
    		
        	$('#dt_fin').val($("#data_final_lote").val() );
    	}
        if( $("#tipoterminal_lote").val() != ""){
    		
        	$('#tipoterminal').val($("#tipoterminal_lote").val() );
    	}
        if( $("#dt_ini").val() != "" && $("#dt_fin").val() != ""&& $('#tipoterminal').val() != "")
              fnPesquisar('#dadoslista_monitoramento','monitoramento','Dados não existentes!');
